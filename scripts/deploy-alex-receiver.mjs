...
async function main() {
  console.log("=======================================================");
  console.log("  FlashStack -- Deploy ALEX STX/ALEX Arb Receiver v5  ");
  console.log("=======================================================");
  ...
  const NAME     = "alex-arb-receiver-v5";
  const PATH     = "contracts/alex-arb-receiver-v5.clar";
  const receiver = `${DEPLOYER}.${NAME}`;

  // Step 1: Deploy
  console.log("Step 1 -- Deploy alex-arb-receiver-v5");
  ...
  await waitForConfirm(deployTxid, "deploy alex-arb-receiver-v5");
  console.log();
