 ...
 * When profitable: flash-borrows STX from FlashStack, executes via alex-arb-receiver-v3.
 *
 ...
 * Factor:   u100000000
 * Receiver: SP20XD46NGAX05ZQZDKFYCCX49A3852BQABNP0VG5.alex-arb-receiver-v3
 *
 * Arb opportunity:
...
// FlashStack receiver
const RECEIVER = `${DEPLOYER}.alex-arb-receiver-v3`;
