...
- **F-6 cannot be fixed in place.** It's recorded here as a live, open, low-severity gap on immutable contracts, not as a to-do — the correct response is migration to v2, not a patch.
