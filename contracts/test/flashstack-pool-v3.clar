;; LOCAL TEST COPY of contracts/flashstack-pool-v3.clar for simnet. Only the
;; use-trait targets differ (dot-sugar local mirrors instead of mainnet
;; principals); all pool/flash-loan logic is byte-identical.
